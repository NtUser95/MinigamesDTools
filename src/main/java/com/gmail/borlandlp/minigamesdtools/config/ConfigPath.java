...
public enum ConfigPath {
    ...
    RESPAWN_LOBBY(new File(MinigamesDTools.getInstance().getDataFolder().getAbsoluteFile(), "respawnlobby.yml"), false, "respawn_lobby"),
    SPECTATOR_LOBBY(new File(MinigamesDTools.getInstance().getDataFolder().getAbsoluteFile(), "spectatorlobby.yml"), false, "spectator_lobby"),
    STARTER_LOBBY(new File(MinigamesDTools.getInstance().getDataFolder().getAbsoluteFile(), "starterlobby.yml"), false, "starter_lobby"),
